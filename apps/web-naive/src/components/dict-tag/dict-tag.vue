...
// import { isHexColor } from '@/utils/color' // TODO @芋艿：【可优化】增加 cssClass 的处理 https://gitee.com/zidacode/zida-ui-admin-vben/blob/v2.4.1/src/components/DictTag/src/DictTag.vue#L60
